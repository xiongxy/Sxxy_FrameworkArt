...
{
    interface IBaseSingleOperationViewModel<out T> where T : BaseEntity
    {
        /// <summary>
        /// 当前对象的实体
        /// </summary>
    ...
    public class BaseSingleOperationViewModel<TModel> : BaseViewModel, IBaseSingleOperationViewModel<TModel> where TModel : BaseEntity
    {
        /// <summary>
        /// 当前对象的实体
        /// </summary>
        ...
        /// 构造函数
        /// </summary>
        public BaseSingleOperationViewModel()
        {
            //初始化Entity
